...
//max_delivery_status_inactive_time
        BusinessSetting::updateOrInsert(['key' => 'min_amount_to_pay_dm'], [
         ...
         BusinessSetting::updateOrInsert(['key' => 'max_delivery_status_inactive_time'], [
            'value' => $request['max_delivery_status_inactive_time']
        ]);
    ...
    public function update_order(Request $request)
    {
        ...
        DB::table('business_settings')->updateOrInsert(['key' => 'max_orders_to_cancel'], [
            'value' => $request['max_orders_to_cancel']
        ]);
