...
class ItemController extends Controller
{
    ...
    //   $items['products'] = array_map(function ($q) {
    //     $q['components'] = \App\Models\ItemAttributes::where('item_id', $q['id'])->pluck('name') ;
    //     return $q ; 
    //  }, $items['products']);
    ...
    //   $item['components'] = \App\Models\ItemAttributes::where('item_id', $item['id'])->pluck('name', 'id');
    //     return $item;
    //   });
    ...
    {
        // try {
            // return   \App\Models\ItemAttributes::where('item_id',$id)->pluck('name','id');
            ...
            $item['components'] = \App\Models\ItemAttributes::where('item_id',$id)->pluck('name','id');
