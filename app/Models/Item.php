...
{
    return $this->hasMany(
        ItemAttributes::class, // Related model
        'item_id',             // Foreign key on pivot table that points to the current model (Item)
        'id'         // Foreign key on pivot table that points to the related model (ItemAttributes)
     ...
     public function components()
{
    ...
    //   public function components()
    // {
    //     return $this->belongsToMany(\App\Models\ItemAttributes::class);
    // }
