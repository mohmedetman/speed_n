                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6 col-lg-4">
                                  ...
                                  <div class="col-sm-6 col-lg-4">
                                        @php($max_delivery_status_inactive_time = \App\Models\BusinessSetting::where('key', 'max_delivery_status_inactive_time')->first())
                                        <div class="form-group mb-0">
                                            <label class="input-label text-capitalize d-flex alig-items-center"
                                                ...
                                                <span class="pr-1 d-flex align-items-center switch--label">
                                                    <span class="line--limit-1">
                                                        {{ translate('messages.Time_max_men_Delivery') }}
                                                    </span>
                                                    ...
                                                    data-original-title="{{ translate('messages.By_activating_this_feature,_customers_can_choose_their_suitable_delivery_slot_according_to_a_30-minute_or_1-hour_interval_set_by_the_Admin.') }}"><img
                                                        src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                        alt="{{ translate(' Delivery') }}"></span>
                                                </span>
                                            </label>
                                            <div class="d-flex">
                                                <input type="number" name="max_delivery_status_inactive_time" class="form-control mr-3"
                                                id="max_delivery_status_inactive_time"
                                                value="{{ $max_delivery_status_inactive_time->value }}"
                                                min="0" required>
