                            ...
                            <div class="py-2">
                                <div class="row g-3 align-items-end">
                                    ...
                                    <div class="col-sm-6 col-lg-4">
                                       ...
                                       <div class="col-sm-6 col-lg-4">
                                        @php($max_orders_to_cancel = \App\Models\BusinessSetting::where('key', 'max_orders_to_cancel')->first())
                                        @php($schedule_order_slot_duration_time_format = \App\Models\BusinessSetting::where('key', 'schedule_order_slot_duration_time_format')->first())
                                        <div class="form-group mb-0">
                                            <label class="input-label text-capitalize d-flex alig-items-center"
                                                for="schedule_order_slot_duration">
                                                ...
                                                <span class="pr-1 d-flex align-items-center switch--label">
                                                    <span class="line--limit-1">
                                                        {{ translate('messages.max_orders_to_cancel') }}
                                                    </span>
                                                    <span class="form-label-secondary text-danger"
                                                    data-toggle="tooltip" data-placement="right"
                                                    data-original-title="من خلال هذه المده تحديد اقصي مده للاوردر للالغاء"><img
                                                        src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                        alt="{{ translate('Home Delivery') }}"></span>
                                                </span>
                                            </label>
                                            <div class="d-flex">
                                                <input type="number" name="max_orders_to_cancel" class="form-control mr-3"
                                                id="schedule_order_slot_duration"
                                                value="{{ $max_orders_to_cancel?->value ?? 8 }}"
                                                min="0" required>
