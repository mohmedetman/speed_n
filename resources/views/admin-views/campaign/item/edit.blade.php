                                    ...
                                    <div class="col-md-12" id="list">
                                        <div class="customer_choice_options" id="customer_choice_options">
                                            <ul id="attribute_list" class="list-unstyled mt-3">
                                                @foreach(\App\Models\ItemAttributes::where('item_id',$campaign->id)->get() as $attribute)
                                                    ...
                                                    <li class="list-group-item">
                                                        <input type="checkbox"
                                                               ...
                                                               name="attribute[]"
                                                            {{ $attribute->isActive ? 'checked' : '' }}>
                                                        <input type="hidden"
                                                               value="{{ $attribute->name }}"
                                                               name="attributeValue[]">
                                                        <label for="attr_{{ $attribute->id }}" class="ms-2">{{ $attribute->name }}</label>
                                                    </li>
        ...
        $(document).ready(function () {
            $('#add_attribute').click(function () {
                ...
                if (attributeValue !== '') {
                    const listItem = `
                <li class="list-group-item">
                    <input type="checkbox" class="form-check-input" id="attr_${attributeValue}" value="${attributeValue}" name="attribute[]" checked>
