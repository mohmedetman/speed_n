...
@push('css_or_js')
    ...
    <style>
        ...
        #attribute_list input[type="checkbox"] {
            margin-right: 10px;
        }
                            ...
                            <div class="row g-2">
                                <div class="col-12">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlSelect1">{{translate('messages.attribute')}}<span
                                                class="input-label-secondary"></span></label>
                                        <div class="d-flex">
                                            <input type="text" class="form-control me-2" name="choice_attributes" min="0" id="choice_attributes" placeholder="أدخل العنصر">
                                            <button type="button" class="btn btn-primary" id="add_attribute">إضافة</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12" id="list">
                                    <div class="customer_choice_options" id="customer_choice_options">
                                        <ul id="attribute_list" class="list-unstyled mt-3">
                                            <!-- العناصر التي يتم إضافتها ستظهر هنا -->
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-12">
    ...
    <script>
        $(document).ready(function () {
            $('#add_attribute').click(function () {
                const attributeValue = $('#choice_attributes').val().trim();

                if (attributeValue !== '') {
                    const isChecked = $('#default_checked').val();

                    const listItem = `
    <li class="list-group-item">
        <input type="checkbox" class="form-check-input" id="attr_${attributeValue}" value="${attributeValue}" name="attribute[]">
        <input type="hidden" value="${attributeValue}" name="attributeValue[]">
        <label for="attr_${attributeValue}" class="ms-2">${attributeValue}</label>
    </li>
`;

                    $('#attribute_list').append(listItem);
    ...
    <script>
        ...
        //     var name = $('#choice_attributes').val(); //
        //     console.log('ss',);
        //
        //     if (name.trim() === '') {
        //         alert('الرجاء إدخال قيمة قبل الإضافة');
        //     } else {
        //         $(this).parent().parent().parent().parent().find('#list').find('#customer_choice_options').find('ul').append();
        //         var added = '<li>' + name + '</li>';
        //         $('#attribute_list').append(added);
        //     }
        // });
        // $('#add_attribute').on('click', function () {
        //     var name = $('#choice_attributes').val(); // Get the value from the text input
        //     if (name.trim() === '') {
        //         alert('Please enter a value before adding.');
        //     } else {
        //         var parentContainer = $(this).closest('.row');
        //         var attributeList = $parentContainer.find('#attribute_list');
        //         console.log(attributeList)
        //         attributeList.append('<li>' + name + '</li>');
        //
        //         $('#choice_attributes').val('');
        //     }
        // });
