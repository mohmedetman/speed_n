            ...
            <div class="card-body">
                <form action="{{isset($category)?route('admin.category.update',[$category['id']]):route('admin.category.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mt-3">
                        <label class="input-label">{{ translate('messages.visibility') }}</label>
                        <div class="d-flex align-items-center">
                            <div class="form-check mr-3">
                                <input class="form-check-input" type="radio" name="visibility" id="visibilityVendor" value="vendor"
                                    {{ old('visibility') == 'vendor' ? 'checked' : '' }}>
                                <label class="form-check-label" for="visibilityVendor">
                                    {{ translate('messages.view_in_app_to_vendor') }}
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="visibility" id="visibilityCustomer" value="user"
                                    {{ old('visibility') == 'user' ? 'checked' : '' }}>
                                <label class="form-check-label" for="visibilityCustomer">
                                    {{ translate('messages.view_in_app_to_user') }}
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="columnSearchDatatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0 text-center">{{translate('messages.visibility')}}</th>
