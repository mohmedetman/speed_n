    ...
    <div class="content container-fluid">
        ...
        <form action="javascript:" method="post" id="product_form" enctype="multipart/form-data">
            ...
            <div class="row g-2">
                ...
                <!--<div class="col-md-6" id="time_input"style="display:none;">-->
                <!--    <div class="card shadow--card-2 border-0">-->
                <!--        <div class="card-header">-->
                <!--            <h5 class="card-title">-->
                    ...
                    <div class="card shadow--card-2 border-0">
                        ...
                        <div class="card-body pb-0">
                            <div class="row g-2">
                                <div class="col-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="components" placeholder="components" data-role="tagsinput" value = "{{$components}}">
                                    </div>
                                </div>
                            </div>
                        </div>
