...
col-md-12">
                    <div class="card shadow--card-2 border-0">
                        ...
                        <div class="card-body">
                            <div class="row g-2 align-items-end">
                                ...
                                <div class="col-sm-6 col-lg-3 d-none" id="condition_input">
                                    <div class="form-group mb-0">
                                ...
                                <div class="col-sm-6 col-lg-3 d-none" id="unit_input">
                                    <div class="form-group mb-0">
                                ...
                                <div class="col-sm-6 col-lg-3 d-none" id="veg_input">
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                ...
                                @if(Config::get('module.current_module_type') == 'grocery' || Config::get('module.current_module_type') == 'food')
                                    ...
                                    <div class="col-sm-6 d-none" id="nutrition">
                                    ...
                                    <div class="col-sm-6 d-none" id="allergy">
                                        <label class="input-label" for="sub-categories">
                                ...
                                <div class="col-sm-6 col-lg-3 d-none" id="maximum_cart_quantity">
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                        ...
                                        <input   value="100000"   type="number"  placeholder="{{ translate('messages.Ex:_10') }}" class="form-control" name="maximum_cart_quantity" min="0" id="cart_quantity">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-3 d-none" id="organic">
                                ...
                                <div class="col-sm-6 col-lg-3 d-none" id="basic">
                                    <div class="form-check mb-sm-2 pb-sm-1">
                                ...
                                @if(Config::get('module.current_module_type') == 'pharmacy')
                                    ...
                                    <div class="col-sm-6 d-none" id="generic_name">
                                        <label class="input-label" for="sub-categories">
                                ...
                                @if(Config::get('module.current_module_type') == 'grocery' || Config::get('module.current_module_type') == 'food')
                                    <div class="col-sm-6 col-lg-3 d-none" id="halal">
                                        <div class="form-check mb-sm-2 pb-sm-1">
                ...
                <div class="col-lg-12 d-none" id="food_variation_section">
                    <div class="card shadow--card-2 border-0">
        ...
        <div class="card shadow--card-2 border-0">
            ...
            <div class="card-body pb-0">
                <div class="row g-2">
                    <div class="col-12">
                        <div class="form-group">
                            <input type="text" class="form-control" name="components" placeholder="components" data-role="tagsinput">
                        </div>
                    </div>
                </div>
            </div>
