                    ...
                    <div class="card shadow--card-2">
                        <div class="card-body">
                            ...
                            id="default-form">
                                ...
                                <div class="form-group">
                                    <label class="input-label"
                                           for="default_name">Delivery price

                                    </label>
                                    <input type="text" name="delivery_price"
                                           class="form-control" placeholder="Delivery price" value="{{$store->getRawOriginal('delivery_price')}}"
                                           required
                                    >
                                </div>
                                ...
                                <div class="form-group mb-0">
                                  ...
                                  <div class="form-group mb-0">
                                    <label class="input-label"
                                        for="exampleFormControlInput1">{{ translate('messages.bio') }} ({{ translate('messages.default') }})</label>
                                    <textarea type="text" name="bio" placeholder="{{translate('messages.store')}}" class="form-control min-h-90px ckeditor">{{$store->getRawOriginal('bio') ?? ''}}</textarea>
                                </div>
                            </div>
                                @foreach (json_decode($language) as $lang)
                                <?php
