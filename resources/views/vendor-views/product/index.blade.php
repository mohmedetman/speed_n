...
@php($module_type = \App\CentralLogics\Helpers::get_store_data()->module->module_type)
    <div class="content container-fluid">
        ...
        <form action="javascript:" method="post" id="item_form"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row g-2">
                                ...
                                <div class="col-sm-6 col-lg-4 d-none" id="organic">
                                ...
                                <div class="col-sm-3 col-lg-3 d-none" id="basic">
                                    <div class="form-check mb-0 p-6">
                                ...
                                <div class="col-sm-6 col-lg-4 d-none" id="halal">
                                    <div class="form-check mb-0 p-6">
                ...
                @endif
                <div class="col-md-12"> <div class="card shadow--card-2 border-0"> <div class="card-header"> <h5 class="card-title"> <span class="card-header-icon"><i class="tio-label"></i></span> <span>{{ translate('components') }}</span> </h5> </div> <div class="card-body pb-0"> <div class="row g-2"> <div class="col-12"> <div class="form-group"> <input type="text" class="form-control" name="components" placeholder="components" data-role="tagsinput"> </div> </div> </div> </div> </div> </div>
