...
<div class="tab-pane fade show active" id="product">
            ...
            <div class="col-12 mb-3">
                <div class="row g-2">
                    ...
                    @php($item = \App\Models\Item::count())
                    ...
                    @php( $item = \App\Models\Item::where(['status' => 1])->count())
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100"
                        href="{{ route('vendor.item.list', ['sub_tab' => 'active-items']) }}">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                    ...
                    @php( $item = \App\Models\Item::where([ 'status' => 0])->count())
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100"
                            href="{{ route('vendor.item.list', ['sub_tab' => 'inactive-items']) }}">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                    ...
                    @php($item = \App\Models\TempProduct::where([ 'is_rejected' => 0])->count())
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100"
                            href="{{ route('vendor.item.list', ['sub_tab' => 'pending-items']) }}">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                    ...
                    @php($item = \App\Models\TempProduct::where([ 'is_rejected' => 1])->count())
                    <div class="col-sm-6 col-lg-3">
                        <a class="order--card h-100"
                            href="{{ route('vendor.item.list', [ 'sub_tab' => 'rejected-items']) }}">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
