...
|
*/
Route::get('max_orders_to_cancel',function(){
 return response()->json(\DB::table('business_settings')->where('key','max_orders_to_cancel')->first()->value ?? 5);

//   return  ; //max_delivery_status_inactive_time
}); 
    ...
    Route::group(['prefix' => 'vendor', 'namespace' => 'Vendor', 'middleware'=>['vendor.api']], function () {
       ...
       // advertisement
        ...
        Route::group(['prefix' => 'delivery-man'], function () {
            ...
            //  Route::get('listActive', 'DeliveryManController@listActive');
...
Route::get('get-active-delivary-men',function(){

  return  response()->json(\App\Models\DeliveryMan::where('active',1)->count() ?? 5); 
});
Route::get('max_delivery_status_inactive_time',function(){
 
  return  response()->json(\DB::table('business_settings')->where('key','max_delivery_status_inactive_time')->first()->value??5); //max_delivery_status_inactive_time
}); 
